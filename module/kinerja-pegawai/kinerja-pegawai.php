...
switch ((isset($url['act']) ? $url['act'] : '')) {
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title fa fa-plus"> Tambah Data SKP Tahunanss</h4>
                            </div>
                            <form role="form" action="<?php echo $aksi . paramEncrypt('module=kinerja-pegawai&act=add-skp-tahunan&id=' . $id_user . ''); ?>" method="post"> 
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="kd_skp"  data-placeholder="-Pilih SKP-" style="width: 100%;" required>
                                            ...
                                            <?php
                                            if ($_SESSION['id_level']=='LVL-000011') {
                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $no = 0;
                            if ($_SESSION['id_level']=='LVL-000011') {
                                $tt_skptahunan = bukaquery("SELECT tm_pegawai.nip, tm_unit.nama_unit, tm_skp_pjlp.skp, tt_skptahunan.id_skp, tt_skptahunan.kd_skp, tt_skptahunan.kuantitas, tt_skptahunan.tgl_buat, tt_skptahunan.tgl_update, tm_skp_pjlp.waktu
                                                        FROM tt_skptahunan
                                                        INNER JOIN tm_skp_pjlp ON tt_skptahunan.kd_skp = tm_skp_pjlp.kd_skp
                                                        ...
                                                        where tt_skptahunan.id_user='$id_user'");
                            }else {
                            ...
                            <div class="modal fade" id="modal-ubah-<?php echo $row['id_skp']; ?>"  role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form action="<?php echo $aksi . paramEncrypt('module=kinerja-pegawai&act=update-skp-tahunan&id=' . $row['id_skp'] . ''); ?>" method="POST" role="form">
                                            <div class="modal-header">
                            ...
                            <div class="modal fade" id="modal-hapus-<?php echo $row['id_skp']; ?>" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form action="<?php echo $aksi . paramEncrypt('module=kinerja-pegawai&act=delete-skp-tahunan&id=' . $row['id_skp'] . ''); ?>" method="POST" role="form">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <th colspan="4"><?php
                        if ($_SESSION['id_level']=='LVL-000011') {
                            $total_target = getOne("SELECT sum(tt_skptahunan.kuantitas * tm_skp_pjlp.waktu) from tt_skptahunan INNER JOIN tm_skp_pjlp ON tt_skptahunan.kd_skp = tm_skp_pjlp.kd_skp where tt_skptahunan.id_user='$id_user'");
                        }else{
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="kd_skp"  data-placeholder="-Pilih SKP-" style="width: 100%;" required>
                                            ...
                                            <?php
                                            if ($_SESSION['id_level']=='LVL-000011') {
                                                $tt_skptahunan = bukaquery("SELECT tm_skp_pjlp.skp, tm_skp_pjlp.waktu, tm_skp_pjlp.kd_skp FROM tt_skptahunan INNER JOIN tm_skp_pjlp ON tt_skptahunan.kd_skp = tm_skp_pjlp.kd_skp where tt_skptahunan.id_user=" . $id_user . "");
                                            }else {
                ...
                <div class="box-body table-responsive">
                    <table id="kinerja" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            if ($_SESSION['id_level']=='LVL-000011') {
                            $tt_kinerja = bukaquery("SELECT tm_pegawai.nip, tm_skp_pjlp.skp, tt_kinerja.id_kinerja, tt_kinerja.uraian, tt_kinerja.waktu_mulai, tt_kinerja.waktu_akhir, tt_kinerja.date, tm_skp_pjlp.waktu, tt_kinerja.kd_skp, tt_kinerja.tanggal_kinerja, tt_kinerja.`status`
                                                    FROM tt_kinerja
                                                    INNER JOIN tm_skp_pjlp ON tt_kinerja.kd_skp = tm_skp_pjlp.kd_skp
                ...
                <div class="box-body table-responsive">
                    <table id="kinerja" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $no = 0;
                            if ($_SESSION['id_level']=='LVL-000011') {
                            $tt_kinerja = bukaquery("SELECT tm_pegawai.nip, tm_skp_pjlp.skp, tt_kinerja.id_kinerja, tt_kinerja.uraian, tt_kinerja.waktu_mulai, tt_kinerja.waktu_akhir, tt_kinerja.date, tm_skp_pjlp.waktu, tt_kinerja.kd_skp, tt_kinerja.tanggal_kinerja, tt_kinerja.`status`, tt_kinerja.validasi 
                                                    FROM tt_kinerja
                                                    INNER JOIN tm_skp_pjlp ON tt_kinerja.kd_skp = tm_skp_pjlp.kd_skp
                                                    INNER JOIN tm_pegawai ON tt_kinerja.id_user = tm_pegawai.id_user
    ...
    case"update-kinerja-pegawai":
        $id = isset($url['id']) ? $url['id'] : null;
        if ($_SESSION['id_level']=='LVL-000011') {
        $tt_kinerja = fetch_array(bukaquery("SELECT tm_pegawai.nip, tm_skp_pjlp.skp, tt_kinerja.id_kinerja, tt_kinerja.uraian, tt_kinerja.waktu_mulai, tt_kinerja.waktu_akhir, tt_kinerja.date, tm_skp_pjlp.waktu, tt_kinerja.kd_skp, tt_kinerja.tanggal_kinerja, tt_kinerja.`status`
                                                    FROM tt_kinerja
                                                    INNER JOIN tm_skp_pjlp ON tt_kinerja.kd_skp = tm_skp_pjlp.kd_skp
                                                    INNER JOIN tm_pegawai ON tt_kinerja.id_user = tm_pegawai.id_user
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="kd_skp"  data-placeholder="-Pilih SKP-" style="width: 100%;" required>
                            ...
                            if ($tt_kinerja['status'] == 'Utama') {
                                if ($_SESSION['id_level']=='LVL-000011') {
                                $tm_skptahunan = bukaquery("SELECT tt_skptahunan.kd_skp, tm_skp_pjlp.skp, tm_skp_pjlp.waktu
                                                            FROM tt_skptahunan INNER JOIN tm_skp_pjlp ON tt_skptahunan.kd_skp = tm_skp_pjlp.kd_skp where tt_skptahunan.id_user=" . $id_user . " ");
                                }else {
